  ...
  describe('测试组件', () => {
    ...
    describe('测试基本用法', () => {
      ...
      it('输入超过max的值，plus按钮应该disabled', () => {
        ...
        $rootScope.$digest();
        var creator = new Creator(element);
        var $plusButton = creator.plusButton();

        expect($plusButton.hasClass('disabled')).to.be.true;

        var $inputValue = creator.inputValue();
      ...
      it('输入小于min的值，minus按钮应该disabled', () => {
        ...
        $rootScope.$digest();
        var creator = new Creator(element);
        var $minusButton = creator.minusButton();
      ...
      it('默认min值0，max值无', () => {
        ...
        var $buttonMinus = creator.minusButton();
        var $inputValue = creator.inputValue();
      ...
      it('plus和minus功能应该生效', () => {
        ...
        var $buttonMinus = creator.minusButton();
        var $buttonPlus = creator.plusButton();
        var $inputValue = creator.inputValue();
      ...
      it('测试disabled', () => {
        ...
        var $buttonPlus = creator.plusButton();
        var $inputValue = creator.inputValue();
        var $inputValueDiv = creator.inputValueDiv();
      ...
      it('测试浏览器事件：blur and change', () => {
        ...
        expect(creator.controller().vm.value).to.equal('20');
